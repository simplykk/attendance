...
public class ViceMonitor extends UserBase implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 7609593172532943546L;
	
	public ViceMonitor () {
		setUserPermission(new ViceMoniPermission());
	}
